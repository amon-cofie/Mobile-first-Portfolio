...
function popUp(itr) {
  ...
  seeLiveLink.href = "https://amon-cofie.github.io/To-Do-List/";
  seeSourceLink.href = "https://github.com/amon-cofie/To-Do-List";
  ...
  seeLiveLink.appendChild(popUpBtn1Img);
  seeSourceLink.innerText = "See Source";
  seeSourceLink.appendChild(popUpBtn2Img);

  seeLiveLink.style.color = "blue";
  seeSourceLink.style.color = "blue";

  popUpBtn1.appendChild(seeLiveLink);
  popUpBtn2.appendChild(seeSourceLink);
